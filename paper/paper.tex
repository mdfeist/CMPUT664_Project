...
\caption{GitHub graph showing code frequency. Note that the graph was truncated to better show the details. Thus the changes that occur in mid 2015 are much larger than appear. The additions reach over 400k and the deletions go over 300k.}
